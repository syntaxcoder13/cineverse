        ...
        <div className="pt-24 md:pt-32 pb-20 min-h-screen px-4 md:px-8 lg:px-12 max-w-[1600px] mx-auto">
            ...
            {watchlist.length === 0 ? (
                <div className="text-center py-20 bg-white dark:bg-[#18181b] rounded-xl border border-gray-200 dark:border-gray-800">
                    <EyeOff size={48} className="mx-auto text-gray-600 mb-4" />
                    <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-2">Watchlist is empty.</h2>
                    <p className="text-gray-600 dark:text-gray-400 mb-6">Keep track of movies and shows you want to watch later.</p>
                </div>
            ) : (
